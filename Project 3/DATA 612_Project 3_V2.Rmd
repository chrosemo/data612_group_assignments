...
Next, we will built a recommender system for varying values of $k$ and analyze the error between the predictions and the actual ratings. Note that in the SVD Recommender method from the *recommenderlab* library, $k$ represents the percentage of the max size of the latent factor matrix. 
```{r}
