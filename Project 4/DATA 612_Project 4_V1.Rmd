...
* **Rating Threshold:** The threshold to be used for positive ratings. Since our data is on a scale of -10 to 10, we will use 2 as the threshold for a good joke. 
...
We'll pick the model with the best precision:
```{r}
