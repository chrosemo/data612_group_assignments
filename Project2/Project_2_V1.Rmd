...
The combination of parameters that minimizes the mean error includes Pearson's correlation, 100 neighbors, and Z-score normalization.
```{r}
...
For our final evaluation, we compare the user-user and item-item based models, each optimized with those combinations of parameters that minimize mean error. We plot a ROC curve and Precision-recall for each model, and then
