...
In this project we will use the built-in MovieLense dataset from the **recommenderlab** library. We will implement and compare results from several recommendation algorithms. Our recommenders will predict movie ratings given critic and movie profiles as well as critics' past ratings.
