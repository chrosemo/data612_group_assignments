...
# create list for errors
errors.names <- c("RMSE", "MSE", "MAE", 'similarity', 'neighbor items', 'norm')
...
avgResults.ibcf <- as.data.frame(avg(results.ibcf))
plot(avgResults.ibcf$FPR, avgResults.ibcf$TPR)
```
...
# Discussion
This analysis has shown us that
